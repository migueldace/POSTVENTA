            ...
            <form action="<?php echo base_url() ?>ctrl_cliente/ingresar_solicitud" method="post" id="formulario_solicitud">
                    ...
                    <div class="card-content collapse show">
                        <div class="row col-md-12">
                            <div class="col-md-6">
                                ...
                                <input type="hidden" name="rut_cliente" id="rut_cliente" value="<?php echo $rut_cliente?>">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <label for="userinput1"><strong>Correo Electrónico</strong></label>
                ...
                <div class="card">
                    <div class="alert alert-warning">
                        <center><b>------INFORMACIÓN IMPORTANTE-------</b></center>
                        Las garantias son basadas en la Ley N°20.016, publicada en el Diario Oficial de fecha 27 de Mayo de 2005, éstas son las siguientes:<br>
                        <b>A. 10 Años</b> - Cuando se tratan de fallas o defectos que afecten la estructura soportante del inmueble.<br>
                        <b>B. 5 Años</b> - Cuando se tratan de fallas o defectos de los elementos constructivos o de las instalaciones.<br>
                        <b>C. 3 Años</b> - Cuando se tratan de fallas o fefectos que afectan a los elementos de terminaciones o de acabado de las obras.<br>
                        <b>Nota:</b> Garantías sujetas a mantención.
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="select2 form-control" id="origen" name="origen" data-live-search="true">
                                                <option value="">Seleccione donde ocurrió el suceso</option>
                                                <?php 
                                                foreach ($origen as $o) {
...
<script type="text/javascript">
    ...
    function agregar() {
        ...
        var valores_suceso_origen = document.getElementsByClassName('su_or');
        errores = 0;
        valores_su_or = [].map.call(valores_suceso_origen, function(data) {
            if (data.value == suceso_origen) {
                errores++;
            }
        });
        if (errores > 0) {
            Swal.fire('Atención!','No puede ingresar el mismo suceso y el mismo origen nuevamente!','warning');
        }
        else if (suceso == "" || suceso == null) {
        ...
        //DEBO RECORRER EL LISTADO DE SUCESOS ACTUALES Y VERIFICAR SI EXISTE EL SUCESO - ORIGEN INDICADO, SI EXISTE, NO DEJARLO SEGUIR
        else {
            contador_filas++;
            suceso_origen = suceso+"#"+origen;
            fila = "<tr id='fila"+contador_filas+"'><td><b>"+nombre_categoria+"</b></td><td><b>"+nombre_suceso+"</b><input type='hidden' class='su_or' name='suceso_origen[]' id='suceso_origen[]' value='"+suceso_origen+"' ></td><td><b>"+nombre_origen+"</b></td><td style='text-align: center;'><a class='btn btn-danger'  onclick='eliminar_fila("+contador_filas+")'> <i class='fa fa-trash'></i> </a></td></tr>";
