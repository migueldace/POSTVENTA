<div class="content-header row">
    <div class="content-header-left col-md-12 col-12 mb-2">
        <h2 class="content-header-title mb-0">
            <i class="fa fa-file" style="font-size:36px;color:greis"></i> ORIGENES
        </h2>
    </div>
</div>
        ...
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h3 class="modal-title">
                    ...
                    <span class="font-weight-bold">FORMULARIO ORIGENES</span>
                </h3>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="number" id="id_origen" name="id_origen" style="display:none">
                        </div>
...
<script src="<?= base_url() ?>assets/js/Admin/origenes.js" type="text/javascript"></script>