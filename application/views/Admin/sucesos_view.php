<div class="content-header row">
    <div class="content-header-left col-md-12 col-12 mb-2">
        <h2 class="content-header-title mb-0">
            <i class="fa fa-check" style="font-size:36px;color:greis"></i> SUCESOS
        </h2>
    </div>
</div>
        ...
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h3 class="modal-title">
                    ...
                    <span class="font-weight-bold">FORMULARIO SUCESOS</span>
                </h3>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="number" id="id_suceso" name="id_suceso" style="display:none">
                        </div>
                        <div class="col-md-12 form-group">
                            <i class="fa fa-pencil"></i>
                            <span><strong>Nombre:</strong></span>
                            <input type="text" class="form-control" id="suceso" name="suceso" required>
                        </div>
...
<script src="<?= base_url() ?>assets/js/Admin/sucesos.js" type="text/javascript"></script>