<div class="content-header row">
    <div class="content-header-left col-md-12 col-12 mb-2">
        <h2 class="content-header-title mb-0">
            <i class="fa fa-certificate" style="font-size:36px;color:greis"></i> TIPOS DE EDMU
        </h2>
    </div>
</div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="number" id="id_edmu" name="id_edmu" style="display:none">
                        </div>

                        <div class="col-md-12 form-group">
                            <i class="fa fa-pencil"></i>
                            <span><strong>Nombre:</strong></span>
                            <input type="text" class="form-control" id="edmu" name="edmu" required>
                        </div>
...
<script src="<?= base_url() ?>assets/js/Admin/edmu.js" type="text/javascript"></script>