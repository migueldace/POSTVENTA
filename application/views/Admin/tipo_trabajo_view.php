<div class="content-header row">
    <div class="content-header-left col-md-12 col-12 mb-2">
        <h2 class="content-header-title mb-0">
            <i class="fa fa-cog" style="font-size:36px;color:greis"></i> TIPOS DE TRABAJO
        </h2>
    </div>
</div>
        ...
        <div class="modal-content">
            <div class="modal-header bg-info">
                <h3 class="modal-title">
                    ...
                    <span class="font-weight-bold">FORMULARIO EDMU</span>
                </h3>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="number" id="id_tipo_trabajo" name="id_tipo_trabajo" style="display:none">
                        </div>

                        <div class="col-md-12 form-group">
                            <i class="fa fa-pencil"></i>
                            <span><strong>Nombre:</strong></span>
                            <input type="text" class="form-control" id="tipo_trabajo" name="tipo_trabajo" required>
                        </div>
...
<script src="<?= base_url() ?>assets/js/Admin/tipo_trabajo.js" type="text/javascript"></script>