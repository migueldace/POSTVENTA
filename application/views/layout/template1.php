...
<head>
  ...
  <!-- ESTILO WIZARD FORM-->
  <link rel="stylesheet" type="text/css" href="<?= base_url() ?>app-assets/css/jquery.steps.css">
  <!-- ESTILO WIZARD FORM-->
...
<body class="vertical-layout vertical-overlay-menu 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-overlay-menu" data-col="2-columns">
  ...
  <!-- END PAGE VENDOR JS-->
  <!-- WIZARD FORM -->
  <script src="<?= base_url() ?>app-assets/js/scripts/extensions/jquery.steps.js" type="text/javascript"></script>
  <script src="<?= base_url() ?>app-assets/js/scripts/extensions/jquery.steps.min.js" type="text/javascript"></script>
   <!-- WIZARD FORM -->
  <!-- BEGIN STACK JS-->
