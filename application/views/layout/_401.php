...
<head>
  ...
  <title>401 Sin Autenticación</title>
          ...
          <div class="col-12 d-flex align-items-center justify-content-center">
            <div class="col-md-4 col-10 p-0">
              <div class="card-header bg-transparent border-0">
                ...
                <h3 class="text-uppercase text-center">Error 401 <br> Acceso No Autorizado.</h3>
              </div>
              <div class="card-content">
                <fieldset class="row py-2">
                  <div class="text-center col-12">
                    <p>No ha sido posible autenticar la sesión. Si el problema persiste debe comunicarse con el <code>Administrador del Sistema.</code></p>
                  </div>
                </fieldset>
                <div class="row py-2">
                  ...
                  <div class="col-12 col-sm-6 col-md-6">
                    <a href="<?= base_url() ?>ctrl_inicio/logout"" class="btn btn-danger btn-block"><i class="ft-power"></i>  Salir de aquí</a>
                  </div>
                </div>
              </div>
