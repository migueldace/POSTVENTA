<div class="content-header row">
    <div class="content-header-left col-md-12 col-12 mb-2">
        <h2 class="content-header-title mb-0">
            <i class="ft ft-check-square" style="font-size:36px;color:greis"></i> SOLICITUDES ASIGNADAS
        </h2>
    </div>
</div>
...
<script src="<?= base_url() ?>assets/js/Solicitudes/asignadas.js" type="text/javascript"></script>