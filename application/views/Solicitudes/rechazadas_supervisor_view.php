<div class="content-header row">
    <div class="content-header-left col-md-12 col-12 mb-2">
        <h2 class="content-header-title mb-0">
            <i class="ft ft-x-circle" style="font-size:36px;color:greis"></i> SOLICITUDES RECHAZADAS POR SUPERVISOR
        </h2>
    </div>
</div>
...
<script src="<?= base_url() ?>assets/js/Solicitudes/rechazadas_supervisor.js" type="text/javascript"></script>