      ...
      <ul class="nav navbar-nav flex-row">
        ...
        <li class="nav-item">
          <a class="navbar-brand" href="<?= base_url() ?>">
            ...
            <h3 class="brand-text">
              <span class="d-none d-md-inline">SAC PV</span>
    ...
    <div class="navbar-container content" id="nav-superior">
      <div class="collapse navbar-collapse" id="navbar-mobile">
        <ul class="nav navbar-nav mr-auto float-left">
          ...
          <?php require_once 'layout/_menuPlataformas.php' ?>
        </ul>
        <ul class="nav navbar-nav float-right">
          ...
          <li class="dropdown dropdown-user nav-item">
            <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
              ...
              <span class="user-name"><?= $_SESSION['usuario']; ?></span>
            </a>
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <div class="dropdown-menu-header bg-grad-danger" style="padding: 4px">
                <h4 class="dropdown-header m-0">
                  <span class="white text-lowercase"><?= $_SESSION['email']; ?></span>
                  <br>
              ...
              <a class="dropdown-item" href="<?= base_url() ?>ctrl_inicio/logout"><i class="ft-power"></i> Cerrar Sesión</a>
            </div>
          </li>
