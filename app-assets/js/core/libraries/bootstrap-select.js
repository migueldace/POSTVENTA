        ...
        Selectpicker.prototype = {
            ...
            createLi: function() {
                ...
                for (var index = 0, len = selectOptions.length; index < len; index++) {
                    ...
                    if (
                        (
                            (thisData.hidden === true || option.hidden) || (isOptgroup && (parentData.hidden === true || parent.hidden))) || (that.options.hideDisabled && (isDisabled || isOptgroupDisabled))) {
                    ...
                    if (isOptgroup && thisData.divider !== true) {
                        ...
                        if (!previousOption) {
                            ...
                            if (index !== 0 && mainElements.length > 0) { // Is it NOT the first option of the select && are there elements in the dropdown?
                                liIndex++;
                                mainElements.push(generateOption.li(false, classNames.DIVIDER, optID + 'div'));
                                mainData.push({
                                    type: 'divider',
                                    optID: optID
                                });
